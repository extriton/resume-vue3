export default {
    ...
    about: {
        ...
        experience: {
            title: 'Опыт',
            paragraphs: [
                `Разработкой ПО на разных технологиях занимаюсь более 15лет`,
    ...
    resume: {
        ...
        skills: [
            ...
            { name: 'PostgreSQL (Sequelize)', level: 55 },
            { name: 'MongoDB (Mongoose)', level: 55 },
            { name: 'VueJS/Vuex/Vue-Router', level: 80 },
            { name: 'Vue 3/Pinia', level: 75 },
            { name: 'Capacitor', level: 55 },
            { name: 'Nuxt', level: 60 },
    ...
    portfolio: {
        ...
        projects: [
            ...
            },
            {
                ...
                imageFilename: 'maf-telegram.jpg',
                link: 'https://t.me/MinersAndFighters_bot/maf',
                isNew: true
            },
            {
                name: 'Nexdex (terminal)',
                description: 'Nuxt, Capacitor, @injectivelabs',
                imageFilename: 'nexdex-nuxt.jpg',
                link: 'https://app.nexdex.pro/ru/trade/BTC-USDT',
                isNew: true
            },
            {
    ...
    contacts: {
        ...
        info: [
            ...
            */
            ...
            {
                name: 'Telegram:',
                value: '<a href="https://t.me/extriton" title="@Extriton" target="_blank">@Extriton</a>'
            },
            {
                name: 'Skype:',
                value: 'single_wolf3'
